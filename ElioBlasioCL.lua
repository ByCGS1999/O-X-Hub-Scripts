...
coroutine.wrap(
    function()
        while true do
            wait()
            if
                not Character or not Character:FindFirstChild("Humanoid") or
...
mtommygun.MeshId, mtommygun.TextureId =
    "http://www.roblox.com/asset/?id=116679805",
    "http://www.roblox.com/asset/?id=116679995"
...
mtommygunammo.MeshId, mtommygunammo.TextureId =
    "http://www.roblox.com/asset/?id=116740155",
    "http://www.roblox.com/asset/?id=116679995"
...
for i, v in pairs(Character:GetDescendants()) do
    if v:IsA("BasePart") and v.Name ~= "lmagic" and v.Name ~= "rmagic" then
        if
            v ~= Root and v ~= Torso and v ~= Head and v ~= RightArm and v ~= LeftArm and v ~= RightLeg and
                v.Name ~= "lmagic" and
                v.Name ~= "rmagic" and
                v ~= LeftLeg
         then
...
for e = 1, #immortal do
    if immortal[e] ~= nil then
        ...
        if levitate then
            if
                PART.ClassName == "Part" and PART ~= Root and PART.Name ~= eyo1 and PART.Name ~= eyo2 and
                    PART.Name ~= "lmagic" and
                    PART.Name ~= "rmagic"
             then
...
coroutine.wrap(
    function()
        while true do
            wait()
            if not fchar or not fchar:FindFirstChild("Humanoid") or fchar:FindFirstChild("Humanoid").Health <= 0 then
                HumanoidIsDead = true
                break
            end
