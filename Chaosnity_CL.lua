...
Character=workspace:WaitForChild("non")
    ...
    function()
        while wait() do
            if attack == false then
                bp.Position = PlrChar.Torso.Position
            else
                if not bp or bp == nil then
                   hrp,bp = MakeSpinnyPart(); 
                end
            end
            if not Torso:WaitForChild("Neck") then
               wait() 
            end
        end
    end
...
Damagefunc = function(Part, hit, minim, maxim, knockback, Type, Property, Delay, KnockbackType, decreaseblock)
    ...
    if h ~= nil and hit.Parent.Name ~= Character.Name and hit.Parent:FindFirstChild("Torso") ~= nil then
        ...
        if blocked == false then
            ...
            bp.Position = h.Parent:WaitForChild("Torso").Position or h.Parent:WaitForChild("UpperTorso").Position
            ShowDamage(
        ...
        elseif Type == "Target" then
            ...
            if Targetting == false then
                ...
                for i = 1, Property do
                    ...
                    if
                        Humanoid.Health > 0 and Character.Parent ~= nil and TargHum.Health > 0 and TargHum.Parent ~= nil and
                            Targetting == true
                     then
                        swait()
                    end
